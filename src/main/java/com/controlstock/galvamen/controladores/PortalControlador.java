...
public class PortalControlador {
    ...
    @GetMapping("/moduloStock")
    public String moduloStock(ModelMap modelo){
...
//        modelo.put("perfilTs", productoServicio.listadoProductos(6));
        return "moduloStock.html";
    }

    @GetMapping("/moduloMantenimiento")
    public String moduloMantenimiento(){
        return "moduloMantenimiento.html";
    }
